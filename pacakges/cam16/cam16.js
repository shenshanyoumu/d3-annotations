...
cam16.fromColor = function(o) {
  return cam16Convert(o);
};
...
function CAM16(J, a, b, opacity) {
  ...
  if (arguments.length !== 4 && arguments.length != 6) {
    console.error(
      "Invalid number of CAM16 constructor arguments. Received " +
        arguments.length +
        " but expected 4 or 6."
    );
    return undefined;
  ...
  if (C === undefined) {
    ...
    var e_t = compute_eccentricity(h),
      t =
        ((50000.0 / 13.0) * vc.nc * vc.ncb * e_t * Math.sqrt(a * a + b * b)) /
...
var cam16Prototype = (CAM16.prototype = cam16.prototype = Object.create(
  color.prototype
));
