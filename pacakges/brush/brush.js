...
// 参数dim为刷子维度，一般是二维刷子。当然也可以针对带状数据的一维刷子操作
// 刷子操作中会得到刷取区域的像素信息，开发者通过像素信息来与值域的像素区域对比，从而可以得到刷子的“放大”比例。从而调整数据的聚焦空间
function brush(dim) {
